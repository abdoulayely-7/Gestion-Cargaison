...
export class OpenRouteService {
    private static readonly KEY: string = API_OPEN_ROUTE_KEY;
    private static readonly URL: string = API_OPEN_ROUTE_URI;
     ...
     */
    static async getDistanceOSRM(startLat: number, startLng: number, endLat: number, endLng: number): Promise<number> {
     ...
     */
    static async getPlaceName(lat: number, lng: number): Promise<string> {
    ...
    ): Promise<{distanceKm: number, depart: string, arrivee: string}> {
