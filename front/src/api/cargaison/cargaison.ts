 ...
 */
export async function obtenirToutesCargaisons(): Promise<Cargaison[]> {
    try {
 ...
 */
export async function obtenirCargaisonParId(id: number): Promise<Cargaison | null> {
    try {
 ...
 */
export async function obtenirCargaisonsParType(type: string): Promise<Cargaison[]> {
    try {
 ...
 */
export async function obtenirCargaisonsParEtat(etat: string): Promise<Cargaison[]> {
    try {
 ...
 */
export async function mettreAJourCargaison(id: number, cargaison: Partial<Cargaison>): Promise<Cargaison> {
    try {
        const response = await fetch(`${API_BASE_URL}/cargaisons/${id}`, {
            method: 'PATCH',
            headers: {
 ...
 */
export async function supprimerCargaison(id: number): Promise<void> {
    try {
        const response = await fetch(`${API_BASE_URL}/cargaisons/${id}`, {
            method: 'DELETE',
        });
 ...
 */
export async function fermerCargaison(id: number): Promise<Cargaison> {
    try {
        const response = await fetch(`${API_BASE_URL}/cargaisons/${id}`, {
            method: 'PATCH',
            headers: {
 ...
 */
export async function rouvrirCargaison(id: number): Promise<Cargaison> {
    try {
 ...
 */
export function peutEtreRouverte(cargaison: any): boolean {
 ...
 */
export function formaterCoordonnees(lieuDepart: string, lieuArrivee: string): { 
    depart: string, 
    arrivee: string 
} {
    return {
 ...
 */
export function calculerPourcentageAvancement(etatAvancement: string): number {
 ...
 */
export function genererNumeroCargaison(type: string): string {
