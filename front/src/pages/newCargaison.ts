...
const numeroCargaison = document.querySelector("#numeroCargaison") as HTMLInputElement;
// --- Inputs ---
const form = document.getElementById("form") as HTMLFormElement;
const typeTransport = document.getElementById("typeTransport") as HTMLSelectElement;
const poidsMax = document.getElementById("poidsMax") as HTMLInputElement;
const lieuDepart = document.getElementById("lieuDepart") as HTMLInputElement;
const lieuArrivee = document.getElementById("lieuArrivee") as HTMLInputElement;
const distance = document.getElementById("distance") as HTMLInputElement;

// Colis
const expediteurNom = document.getElementById("expediteur_nom") as HTMLInputElement;
const expediteurPrenom = document.getElementById("expediteur_prenom") as HTMLInputElement;
const expediteurEmail = document.getElementById("expediteur_email") as HTMLInputElement;
const expediteurTel = document.getElementById("expediteur_telephone") as HTMLInputElement;

const destinataireNom = document.getElementById("destinataire_nom") as HTMLInputElement;
const destinatairePrenom = document.getElementById("destinataire_prenom") as HTMLInputElement;
const destinataireEmail = document.getElementById("destinataire_email") as HTMLInputElement;
const destinataireTel = document.getElementById("destinataire_telephone") as HTMLInputElement;

const poidsColis = document.getElementById("poids") as HTMLInputElement;
const typeProduit = document.getElementById("typeProduit") as HTMLSelectElement;
...
form.addEventListener("submit", async (e) => {
    ...
    const rules = [
        ...
        { element: typeProduit, validator: () => Validator.required(typeProduit.value), message: ErreurMessages.FR.typeProduit_required },
        {
            ...
            validator: () => {
                ...
                if (produit === ColisType.CHIMIQUE && transport === CargaisonType.MARITIME) return false;
                if (produit === ColisType.MATERIEL_FRAGILE && !(transport === CargaisonType.AERIENNE || transport === CargaisonType.MARITIME)) return false;
    ...
    const cargaison = new Cargaison(
        Number(poidsMax.value),
        typeTransport.value as CargaisonType,
        lieuDepart.value,
        lieuArrivee.value,
        Number(distance.value),
        CargaisonEtatAvancement.EN_ATTENTE,
        "", ""
    );
    ...
    const premierColis = new Colis(
        ColisEtat.EN_ATTENTE,
        Number(poidsColis.value),
        expediteur,
        destinataire,
        typeProduit.value as ColisType,
        cargaison.type,
