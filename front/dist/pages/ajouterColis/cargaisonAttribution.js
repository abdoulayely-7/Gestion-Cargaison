...
export class CargaisonAttribution {
     ...
     */
    static async attribuerColisACargaison(colisData, colisId, cargaisonId) {
        try {
            let cargaisonCible = null;
            if (cargaisonId) {
     ...
     */
    static async verifierCargaisonDisponible(cargaisonId, poidsColis) {
        try {
     ...
     */
    static async trouverCargaisonCompatible(colisData) {
        try {
            const cargaisonsDisponibles = await CargaisonService.obtenirCargaisonsDisponibles();
            // Filtrer les cargaisons compatibles
            const cargaisonsCompatibles = cargaisonsDisponibles.filter(cargaison => !this.estCargaisonFermee(cargaison) &&
     ...
     */
    static async effectuerAttribution(cargaison, colisId, poidsColis) {
        try {
     ...
     */
    static estCargaisonFermee(cargaison) {
     ...
     */
    static peutAccueillirPoids(cargaison, poidsColis) {
     ...
     */
    static estTypeCompatible(cargaison, typeColis) {
     ...
     */
    static calculerCoutColis(poids) {
     ...
     */
    static async obtenirCargaisonsDisponiblesPourAffichage() {
        try {
...
//# sourceMappingURL=cargaisonAttribution.js.map