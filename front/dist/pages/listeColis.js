...
import { obtenirTousColis, marquerColisRecupere, marquerColisPerdu, archiverColis, changerEtatColis, obtenirColisParId } from "../api/colis/colis.js";
...
async function marquerCommeRecupere(id) {
    try {
...
async function marquerCommePerdu(id) {
...
async function archiverColisManuel(id) {
...
async function changerEtatColisAction(id) {
...
window.marquerCommeRecupere = marquerCommeRecupere;
window.marquerCommePerdu = marquerCommePerdu;
window.archiverColisManuel = archiverColisManuel;
window.changerEtatColisAction = changerEtatColisAction;
